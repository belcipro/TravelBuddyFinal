...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String id_usuario_login= "Sin ID user";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recuperar el ID de usuario loggeado
        Intent intent = getIntent();
        if (intent.getExtras()!=null){
            respuestaLogin = (RespuestaLogin) intent.getSerializableExtra("data");

            Log.e("TAG", "=>" + respuestaLogin.getID_Usuario());
            respuestaLogin.getID_Usuario();
            id_usuario_login=respuestaLogin.getID_Usuario();
            Toast.makeText(this, "ID: " + id_usuario_login, Toast.LENGTH_LONG).show();
        }

        //No sirve para nada hasta el toolbar
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuTab) {
            ...
            startActivity(new Intent(MainActivity.this, PerfilActivity.class).putExtra("id", id_usuario_login));
            finish();
            ...
            Uri uri = Uri.parse("https://wa.me/51981135334");
